...
public class Const {
    ...
    // API CALL
    public static String API_BASE_URL = "http://api.learn2crack.com";//http://fdsfsdfdsf.net
//    public static String API_HOST = API_BASE_URL + "/api/";//main
    public static String API_HOST = API_BASE_URL + "/android/";//Other
...
//Country Picker
    ...
    public static final String DATALIST_API = "stations.json";
    public static final String DGet_API = "jsonandroid";
